...
class Core(object):
    ...
    def pdu_outlet_state_changed(self, name, outlet_number, state):
        ...
        try:
            ...
            #TODO(mmitchell): Replace by info
            self.logger.warning("Found server '{0}'".format(server_name))
        except KeyError:
            return
